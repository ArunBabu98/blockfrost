...
class _$BlockContent extends BlockContent {
  ...
  factory _$BlockContent([void Function(BlockContentBuilder)? updates]) =>
      (new BlockContentBuilder()..update(updates))._build();
  ...
  _$BlockContent._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(time, r'BlockContent', 'time');
    BuiltValueNullFieldError.checkNotNull(hash, r'BlockContent', 'hash');
    BuiltValueNullFieldError.checkNotNull(
        slotLeader, r'BlockContent', 'slotLeader');
    BuiltValueNullFieldError.checkNotNull(size, r'BlockContent', 'size');
    BuiltValueNullFieldError.checkNotNull(txCount, r'BlockContent', 'txCount');
    BuiltValueNullFieldError.checkNotNull(
        confirmations, r'BlockContent', 'confirmations');
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is BlockContent &&
        ...
        opCert == other.opCert &&
        opCertCounter == other.opCertCounter &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'BlockContent')
          ..add('time', time)
          ..add('height', height)
          ..add('hash', hash)
          ..add('slot', slot)
          ...
          ..add('opCert', opCert)
          ..add('opCertCounter', opCertCounter)
...
class BlockContentBuilder
  ...
  String? _opCert;
  String? get opCert => _$this._opCert;
  set opCert(String? opCert) => _$this._opCert = opCert;

  String? _opCertCounter;
  String? get opCertCounter => _$this._opCertCounter;
  set opCertCounter(String? opCertCounter) =>
      _$this._opCertCounter = opCertCounter;
  ...
  BlockContentBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _opCert = $v.opCert;
      _opCertCounter = $v.opCertCounter;
  ...
  @override
  BlockContent build() => _build();

  _$BlockContent _build() {
    final _$result = _$v ??
        new _$BlockContent._(
            time: BuiltValueNullFieldError.checkNotNull(
                time, r'BlockContent', 'time'),
            height: height,
            hash: BuiltValueNullFieldError.checkNotNull(
                hash, r'BlockContent', 'hash'),
            slot: slot,
            epoch: epoch,
            epochSlot: epochSlot,
            ...
            size: BuiltValueNullFieldError.checkNotNull(
                size, r'BlockContent', 'size'),
            txCount: BuiltValueNullFieldError.checkNotNull(
                txCount, r'BlockContent', 'txCount'),
            output: output,
            fees: fees,
            blockVrf: blockVrf,
            opCert: opCert,
