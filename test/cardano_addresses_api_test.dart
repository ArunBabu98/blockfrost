...
void main() {
  ...
  group(CardanoAddressesApi, () {
    ...
    //
    //Future<AddressContentExtended> addressesAddressExtendedGet(String address) async
    test('test addressesAddressExtendedGet', () async {
      // TODO
    });
    ...
    test('test addressesAddressGet', () async {
      Response<AddressContent> result =
          await instance.addressesAddressGet(address: addr1);
      print(result);
    ...
    test('test addressesAddressTotalGet', () async {
      Response<AddressContentTotal> result =
          await instance.addressesAddressTotalGet(address: addr1);
      print(result);
    });
    ...
    //
    //Future<BuiltList<AddressTransactionsContentInner>> addressesAddressTransactionsGet(String address, { int count, int page, String order, String from, String to }) async
    test('test addressesAddressTransactionsGet', () async {
      Response<BuiltList<AddressTransactionsContentInner>> result =
          await instance.addressesAddressTransactionsGet(
              address: addr2, order: desc, count: 5);
      print(result);
    });
    ...
    test('test addressesAddressTxsGet', () async {
      Response<BuiltList<String>> result = await instance
          .addressesAddressTxsGet(address: addr2, order: desc, count: 5);
      print(result);
    });
    ...
    //
    //Future<BuiltList<AddressUtxoContentInner>> addressesAddressUtxosAssetGet(String address, String asset, { int count, int page, String order }) async
    test('test addressesAddressUtxosAssetGet', () async {
      // Response<BuiltList<AddressUtxoContentInner>> result =
      //     await instance.addressesAddressUtxosAssetGet(address: addr2);
      // print(result);
    });
    ...
    // UTXOs of the address.
    //
    //Future<BuiltList<AddressUtxoContentInner>> addressesAddressUtxosGet(String address, { int count, int page, String order }) async
    test('test addressesAddressUtxosGet', () async {
      Response<BuiltList<AddressUtxoContentInner>> result =
          await instance.addressesAddressUtxosGet(address: addr2);
      print(result);
    });
  });
}
