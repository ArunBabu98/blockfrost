...
// tests for TxContentPoolCertsInnerRelaysInner
void main() {
  final instance = TxContentPoolCertsInnerRelaysInnerBuilder();
  // TODO add properties to the builder and call build()

  group(TxContentPoolCertsInnerRelaysInner, () {
    ...
    // String dnsSrv
    test('to test the property `dnsSrv`', () async {
      // TODO
    });
