...
// tests for BlockContent
void main() {
  final instance = BlockContentBuilder();
  ...
  group(BlockContent, () {
    ...
    // String blockVrf
    test('to test the property `blockVrf`', () async {
      // TODO
    });

    // The hash of the operational certificate of the block producer
    // String opCert
    test('to test the property `opCert`', () async {
      // TODO
    });

    // The value of the counter used to produce the operational certificate
    // String opCertCounter
    test('to test the property `opCertCounter`', () async {
      // TODO
    });

    // Hash of the previous block
    // String previousBlock
    test('to test the property `previousBlock`', () async {
      // TODO
    });

    // Hash of the next block
    // String nextBlock
    test('to test the property `nextBlock`', () async {
      // TODO
    });
